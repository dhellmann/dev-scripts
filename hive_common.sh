...
export HIVE1_BAREMETAL_NETWORK_NAME=${HIVE1_BAREMETAL_NETWORK_NAME:-hive1-baremetal}

export HIVE1_PROVISIONING_NETWORK_NAME=${HIVE1_PROVISIONING_NETWORK_NAME:-hive1-provisioning}
...
export HIVE2_BAREMETAL_NETWORK_NAME=${HIVE2_BAREMETAL_NETWORK_NAME:-hive2-baremetal}

export HIVE2_PROVISIONING_NETWORK_NAME=${HIVE2_PROVISIONING_NETWORK_NAME:-hive2-provisioning}
