...
export HIVE1_NUM_MASTERS=${HIVE1_NUM_MASTERS:-3}
export HIVE1_NUM_WORKERS=${HIVE1_NUM_WORKERS:-0}
export HIVE1_WORKING_DIR=${HIVE1_WORKING_DIR:-"/opt/dev-scripts-hive1"}
...
export HIVE1_BAREMETAL_NETWORK_NAME=${HIVE1_BAREMETAL_NETWORK_NAME:-hive1bare}
...
export HIVE1_NODES_FILE=${HIVE1_NODES_FILE:-"${HIVE1_WORKING_DIR}/ironic_nodes.json"}

export HIVE2_CLUSTER_NAME=${HIVE2_CLUSTER_NAME:-hive2}
export HIVE2_CLUSTER_DOMAIN="${HIVE2_CLUSTER_NAME}.${BASE_DOMAIN}"
export HIVE2_NUM_MASTERS=${HIVE2_NUM_MASTERS:-3}
export HIVE2_NUM_WORKERS=${HIVE2_NUM_WORKERS:-0}
export HIVE2_WORKING_DIR=${HIVE2_WORKING_DIR:-"/opt/dev-scripts-hive2"}
...
export HIVE2_BAREMETAL_NETWORK_NAME=${HIVE2_BAREMETAL_NETWORK_NAME:-hive2bare}
...
export HIVE2_NODES_FILE=${HIVE2_NODES_FILE:-"${HIVE2_WORKING_DIR}/ironic_nodes.json"}
